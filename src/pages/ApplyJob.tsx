        ...
        <div className="container max-w-3xl">
          ...
          <Card className="border-primary/20 shadow-lg backdrop-blur-sm bg-card/95 animate-fade-in-up">
            <CardHeader className="text-center pb-8">
              ...
              <CardTitle className="text-3xl font-raleway font-bold">
                Apply for Position
              </CardTitle>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                >
                  <Label htmlFor="name" className="font-raleway font-semibold">
                    Full Name *
                  </Label>
                  <Input
                    id="name"
                ...
                >
                  <Label htmlFor="email" className="font-raleway font-semibold">
                    Email Address *
                  </Label>
                  <Input
                    id="email"
                ...
                >
                  <Label htmlFor="phone" className="font-raleway font-semibold">
                    Phone Number *
                  </Label>
                  <Input
                    id="phone"
